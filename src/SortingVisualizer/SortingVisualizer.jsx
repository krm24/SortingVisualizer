...
export default class SortingVisualizer extends React.Component {
  ...
  getColor(index) {
    ...
    if (prevChanged.includes(index)) {
      if (
        index === prevChanged[prevChanged.length - 1] ||
        index === prevChanged[prevChanged.length - 2]
      ) {
    ...
    return (
      <div className="main-div" id="centerdiv">
        ...
        <div className="centerdivKeepWidth" id="buttonsDiv">
          ...
          <button onClick={() => this.SortArray(BubbleSort)}>
            Bubble Sort
          </button>
          <button onClick={() => this.SortArray(InsertionSort)}>
            Insertion Sort
          </button>
          <button onClick={() => this.selectionSort()}>Selection Sort</button>
          <button onClick={() => this.SortArray(GetQuickSortAnimation)}>
            Quick Sort
          </button>
        </div>
        <div className="flexDiv">
          <div className="centerdivKeepWidth">
            ...
            <input
              ...
              min="5"
              max="1500"
              onChange={(event) => this.handleItemsInputOnChange(event)}
          ...
          <div className="centerdivKeepWidth">
            ...
            <input
              ...
              min="1"
              max="100"
              onChange={(event) => this.handleDelayInputOnChange(event)}
